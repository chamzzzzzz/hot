...
func TestArchive(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		...
		board.Append4(fmt.Sprintf("Title_%d", i), fmt.Sprintf("Summary_%d", i), fmt.Sprintf("URL_%d", i), fmt.Sprintf("Catagory_%d", i))
		board.Append5(fmt.Sprintf("Title_%d", i), fmt.Sprintf("Summary_%d", i), fmt.Sprintf("URL_%d", i), fmt.Sprintf("Catagory_Extra_%d", i), fmt.Sprintf("Extra_%d", i))
	}
